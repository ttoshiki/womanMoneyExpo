...
<header>
  <div class="header-inner clearfix">
    <div class="headinfo clearfix">
      <a class="logo" href="<?php echo home_url(); ?>"><img src="http://womanmoney-expo.com/wp/wp-content/uploads/2020/01/logo.png" alt="womanmoneyexpo" class="header_logo" style="margin-top:8px;"></a>
