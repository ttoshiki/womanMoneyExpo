<aside id="sidebar">
  <div class="sidebar-inner">
    <div class="banner"><a href="http://smartbe8.com/" target="_blank"><img
          src="<?php bloginfo('template_directory'); ?>/img/smb_banner.png" alt="合同会社Smart Be"></a></div>
    <div class="fb-page" data-href="https://www.facebook.com/smart8EXPO" data-width="500" data-height="400"
      data-tabs="timeline,events" data-hide-cover="false" data-show-facepile="true" data-small-header="false"
  ...
  <div class="banner"><img src="<?php bloginfo('template_directory'); ?>/img/exh_banner.png" alt="出展のご案内"
    ...
    <div class="backDrop"></div><span class="banner__preparation">Coming Soon</span>
  </div>
  <div class="side_sns banner">
    <div class="side_sns__link"><img src="<?php bloginfo('template_directory'); ?>/img/tw_banner.png" alt="公式Twitter"
        class="snsImage">
      <div class="side_sns__backDrop"></div><span class="banner__preparation">Coming Soon</span>
    </div>
  ...
  <div class="banner"><img src="<?php bloginfo('template_directory'); ?>/img/line_banner.png" alt="LINE友だち登録">
    <div class="line__backDrop"></div><span class="banner__preparation">Coming Soon</span>
  </div>
</aside>