    ...
    <div class="container clearfix">
        <div class="contents">
            <div class="faq_summery">
                ...
                <p class="">Smart
                    Beは役割を多く持ち、自分の夢を諦めている女性たちが希望の人生を送れることを願い創業しました。女性起業家のための学校「賢女の集客アカデミー」をスタートし、女性が起業を通じて、理想の生き方を手に入れるサポートを行っています。現在、アカデミーの生徒数は延べ400人を超え、時間にもお金にも縛られない理想のライフスタイルを手に入れた女性を次々と輩出中です。
                    <br>
                    <br>
                    アカデミー最大の特徴はSNSを駆使する点です。
                    忙しい女性が自由を手に入れるためには時間の効率化が必須なため、アカデミーではSNSの拡散力を活用し、ビジネスで最も時間と労力を要する集客を最短で終わらせる独自の方法をお伝えしています。 <br>
                    <br>
                    このSNSを活用した効率的な働き方は起業家女性に限らず、自己実現に悩む多くの女性を救うと考え、今年7月には、同じ志を持った仲間と繋がりながら、楽しくSNSの活用方法が学べる「インフLady」というコミュニティを発足しました。メンバー数は連日伸び続けており、続々と新たなインフルエンサーが誕生しています。
                    <br>
                    <br>
                    また、女性が理想の人生を送るためには経済力だけでなく、外見の美しさや心の豊かさが不可欠であるという考えから、女性の身体や心を磨くセミナー・勉強会も多数開催しています。年内には総合的な美しさを極めるための学校「トータルビューティースクール(仮)」を開校予定です。
                    <br>
                    <br>
                    SmartBeは、今後も女性の身体、心、経済に至る、ライフスタイルの全ての総合的なサポートをする取り組みを続けていきます。
                    <br>
                    <br>
                    <br>
                    <br>
